...
from apex_dashboard_analytics.api.roadmap_routes import roadmap_router
...
v1_router.include_router(roadmap_router)  # registered last: bare {skill_id}/roadmap path
